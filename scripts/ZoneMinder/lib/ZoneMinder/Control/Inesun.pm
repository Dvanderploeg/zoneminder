# ==========================================================================
#
# ZoneMinder Inesun IP Control Protocol Module
...
# protocol
#
package ZoneMinder::Control::Inesun;
...
sub sendCmd {
  ...
  my $result = undef;
  my $full_msg = '<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://www.w3.org/2003/05/soap-envelope" xmlns:SOAP-ENC="http://www.w3.org/2003/05/soap-encoding" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:chan="http://schemas.microsoft.com/ws/2005/02/duplex" xmlns:c14n="http://www.w3.org/2001/10/xml-exc-c14n#" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:saml1="urn:oasis:names:tc:SAML:1.0:assertion" xmlns:saml2="urn:oasis:names:tc:SAML:2.0:assertion" xmlns:wsu="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd" xmlns:xenc="http://www.w3.org/2001/04/xmlenc#" xmlns:wsc="http://docs.oasis-open.org/ws-sx/ws-secureconversation/200512" xmlns:wsse="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd" xmlns:dom0="http://www.axis.com/2009/event" xmlns:xmime="http://tempuri.org/xmime.xsd" xmlns:xop="http://www.w3.org/2004/08/xop/include" xmlns:wsa5="http://www.w3.org/2005/08/addressing" xmlns:tt="http://www.onvif.org/ver10/schema" xmlns:wsrfbf="http://docs.oasis-open.org/wsrf/bf-2" xmlns:wstop="http://docs.oasis-open.org/wsn/t-1" xmlns:wsrfr="http://docs.oasis-open.org/wsrf/r-2" xmlns:tds="http://www.onvif.org/ver10/device/wsdl" xmlns:tev="http://www.onvif.org/ver10/events/wsdl" xmlns:wsnt="http://docs.oasis-open.org/wsn/b-2" xmlns:timg="http://www.onvif.org/ver20/imaging/wsdl" xmlns:tmd="http://www.onvif.org/ver10/deviceIO/wsdl" xmlns:tptz="http://www.onvif.org/ver20/ptz/wsdl" xmlns:trt="http://www.onvif.org/ver10/media/wsdl"><SOAP-ENV:Header>' . ((%identity) ? authentificationHeader($identity{username}, $identity{password}) : '') . '</SOAP-ENV:Header><SOAP-ENV:Body>' . $msg . '</SOAP-ENV:Body></SOAP-ENV:Envelope>';
  ...
  $req->header('content-length' => length($full_msg));
  $req->header('accept-encoding' => 'gzip, deflate');
  $req->header('connection' => 'Close');
  $req->content($full_msg);
...
sub getCamParams {
  my $self = shift;
  my $msg = '<VideoSourceToken>000</VideoSourceToken></GetImagingSettings>';
...
sub autoStop {
  ...
  if ( $autostop ) {
    Debug('Auto Stop');
    my $cmd = 'onvif/PTZ';
    my $msg = '<ProfileToken>' . $profileToken . '</ProfileToken><PanTilt>true</PanTilt><Zoom>false</Zoom></Stop>';
...
sub reset {
  ...
  my $self = shift;
  my $cmd = '';
  my $msg = '<SystemReboot xmlns="http://www.onvif.org/ver10/device/wsdl"/>';
...
sub moveConUp {
  ...
  my $self = shift;
  my $cmd = 'onvif/PTZ';
  my $msg ='<tptz:ContinuousMove><tptz:ProfileToken>MainStream</tptz:ProfileToken><tptz:Velocity><tt:PanTilt x="0" y="0.5" space="http://www.onvif.org/ver10/tptz/PanTiltSpaces/VelocityGenericSpace"></tt:PanTilt></tptz:Velocity></tptz:ContinuousMove>';
  my $content_type = 'application/soap+xml; charset=utf-8; action="http://www.onvif.org/ver20/ptz/wsdl/ContinuousMove"';
  $self->sendCmd($cmd, $msg, $content_type);
...
sub moveConLeft {
  ...
  my $self = shift;
  my $cmd = 'onvif/PTZ';
  my $msg ='<tptz:ContinuousMove><tptz:ProfileToken>MainStream</tptz:ProfileToken><tptz:Velocity><tt:PanTilt x="-0.5" y="0" space="http://www.onvif.org/ver10/tptz/PanTiltSpaces/VelocityGenericSpace"></tt:PanTilt></tptz:Velocity></tptz:ContinuousMove>';
  my $content_type = 'application/soap+xml; charset=utf-8; action="http://www.onvif.org/ver20/ptz/wsdl/ContinuousMove"';
  $self->sendCmd($cmd, $msg, $content_type);
  $self->autoStop($self->{Monitor}->{AutoStopTimeout});
}
...
sub zoomConTele {
  ...
  my $self = shift;
  my $cmd = 'onvif/PTZ';
  my $msg ='<tptz:ContinuousMove><tptz:ProfileToken>MainStream</tptz:ProfileToken><tptz:Velocity><tt:Zoom x="1" space="http://www.onvif.org/ver10/tptz/ZoomSpaces/VelocityGenericSpace"></tt:Zoom></tptz:Velocity></tptz:ContinuousMove>';
  my $content_type = 'application/soap+xml; charset=utf-8; action="http://www.onvif.org/ver20/ptz/wsdl/ContinuousMove"';
  $self->sendCmd($cmd, $msg, $content_type);
  $self->autoStop($self->{Monitor}->{AutoStopTimeout});
}
...
sub moveConUpRight {
  ...
  my $self = shift;
  my $cmd = 'onvif/PTZ';
  my $msg ='<tptz:ContinuousMove><tptz:ProfileToken>MainStream</tptz:ProfileToken><tptz:Velocity><tt:PanTilt x="0.5" y="0.5" space="http://www.onvif.org/ver10/tptz/PanTiltSpaces/VelocityGenericSpace"></tt:PanTilt></tptz:Velocity></tptz:ContinuousMove>';
  my $content_type = 'application/soap+xml; charset=utf-8; action="http://www.onvif.org/ver20/ptz/wsdl/ContinuousMove"';
  $self->sendCmd($cmd, $msg, $content_type);
  $self->autoStop($self->{Monitor}->{AutoStopTimeout});
}
...
sub moveStop {
  ...
  my $self = shift;
  my $cmd = 'onvif/PTZ';
  my $msg ='<tptz:Stop><tptz:ProfileToken>MainStream</tptz:ProfileToken><tptz:PanTilt>true</tptz:PanTilt><tptz:Zoom>false</tptz:Zoom></tptz:Stop>';
  my $content_type = 'application/soap+xml; charset=utf-8; action="http://www.onvif.org/ver20/ptz/wsdl/ContinuousMove"';
  $self->sendCmd($cmd, $msg, $content_type);
}
...
sub presetSet {
  ...
  my $cmd = 'onvif/PTZ';
  my $msg ='<tptz:SetPreset><tptz:ProfileToken>MainStream</tptz:ProfileToken><tptz:PresetToken>' . $preset . '</tptz:PresetToken></tptz:SetPreset>';
...
sub presetGoto {
  ...
  my $cmd = 'onvif/PTZ';
  my $msg ='<tptz:GotoPreset><tptz:ProfileToken>MainStream</tptz:ProfileToken><tptz:PresetToken>' . $preset . '</tptz:PresetToken></tptz:GotoPreset>';
  my $content_type = 'application/soap+xml; charset=utf-8; action="http://www.onvif.org/ver20/ptz/wsdl/PresetNum"';
  $self->sendCmd( $cmd, $msg, $content_type );
}
